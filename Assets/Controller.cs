...
{
    [SerializeField] private SkinnedMeshRenderer[] _linkedRenderer;
    ...
    private void Start()
    {
        ...
        _sheet.SetVector("_EffectOrigin", originPos);

        if (_linkedRenderer != null) foreach (var r in _linkedRenderer) r.SetPropertyBlock(_sheet);
    }
